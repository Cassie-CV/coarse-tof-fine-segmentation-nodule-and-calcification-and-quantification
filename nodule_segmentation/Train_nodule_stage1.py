...
if __name__ == '__main__':
    ...
    parser.add_argument('--filepath_img', type=str, default='./train_dataset/image_stage1_256')
    parser.add_argument('--filepath_mask', type=str, default='./train_dataset/mask_stage1_256')
    ...
    # result&save
    parser.add_argument('--result_path', type=str, default='./result/nodule_stage1')

...
if __name__ == '__main__':
    ...
    # data-parameters
    parser.add_argument('--weight_pretrain_path', type=str, default='./models/best_unet_score.pkl')

    parser.add_argument('--filepath_img', type=str, default='./train_dataset/image_stage2_512')
    parser.add_argument('--filepath_mask', type=str, default='./train_dataset/mask_stage2_512')
    parser.add_argument('--csv_file', type=str, default='./train_dataset/train.csv')
    parser.add_argument('--fold_K', type=int, default=5, help='folds number after divided')
    parser.add_argument('--fold_idx', type=int, default=1)

    # result&save
    parser.add_argument('--result_path', type=str, default='./result/nodule_stage2')
